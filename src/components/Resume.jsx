      ...
      <div id="container-resume" className="lg:h-[490px] lg:overflow-y-auto">
        ...
        <div id="cantainer-2" className="py-2">
          ...
          >
            ...
            1.5 years of Experience in working on SPFX webparts development, PowerApps and Power Automate. {""}
            </li>
            <li className="text-xs w-full  pt-2">
            Develop workflows, Used Pnp and ReactJS for SharePoint during SPFx› webpart development. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            Worked on Customizing SharePoint list (CRUD) operation using JSON, API and SP Services. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            Good hands-on Creating Canvas apps for SharePoint list. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            Experienced in Power automate Approval flow, Reporting, Bulk data update in data source, HTTP Context, Scheduled cloud flow. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            Implemented the Http requests (get, post, and delete) actions in flows. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            SPFX webpart development using class and functional components. {" "}
            </li>

            <li className="text-xs w-full  pt-2">
            End to end SPFX package deployment into SharePoint sites. Configure the apps in app catalog. {" "}
            </li>
          </div>
        </div>
